...
import { c as te, a as Wt, b as Ht, B as Ve } from "./colorToUniform68754.js";
import { C as O } from "./CanvasPool68754.js";
class $e {
  static init(e) {
...
class je {
  static init(e) {
    (e = Object.assign({ autoStart: !0, sharedTicker: !1 }, e)),
      Object.defineProperty(this, "ticker", {
        set(t) {
          this._ticker && this._ticker.remove(this.render, this),
            (this._ticker = t),
            t && t.add(this.render, this, gt.LOW);
        },
        get() {
          return this._ticker;
        },
      ...
      (this._ticker = null),
      (this.ticker = e.sharedTicker ? _e.shared : new _e()),
...
function Z(a) {
  ...
  for (let r = t.length - 1; r >= 0; r--) {
    let n = t[r].trim();
    !/([\"\'])[^\'\"]+\1/.test(n) && !It.includes(n) && (n = `"${n}"`),
      (t[r] = n);
  }
  return `${a.fontStyle} ${a.fontVariant} ${a.fontWeight} ${e} ${t.join(",")}`;
}
const ne = { willReadFrequently: !0 },
  A = class g {
    ...
    static measureText(e = " ", t, r = g._canvas, n = t.wordWrap) {
      var S;
      const i = `${e}:${t.styleKey}`;
      if (g._measurementCache[i]) return g._measurementCache[i];
      const s = Z(t),
        o = g.measureFont(s);
      o.fontSize === 0 && ((o.fontSize = t.fontSize), (o.ascent = t.fontSize));
      const l = g.__context;
      l.font = s;
      const c = (n ? g._wordWrap(e, t, r) : e).split(/(?:\r\n|\r|\n)/),
        u = new Array(c.length);
      let f = 0;
      for (let b = 0; b < c.length; b++) {
        const T = g._measureText(c[b], t.letterSpacing, l);
        (u[b] = T), (f = Math.max(f, T));
      }
      const m = ((S = t._stroke) == null ? void 0 : S.width) || 0;
      let p = f + m;
      t.dropShadow && (p += t.dropShadow.distance);
      const h = t.lineHeight || o.fontSize;
      let _ = Math.max(h, o.fontSize + m) + (c.length - 1) * (h + t.leading);
      return (
        t.dropShadow && (_ += t.dropShadow.distance),
        new g(e, t, p, _, c, u, h + t.leading, f, o)
      );
    }
    static _measureText(e, t, r) {
      ...
      g.experimentalLetterSpacingSupported &&
        (g.experimentalLetterSpacing
          ? ((r.letterSpacing = `${t}px`),
            (r.textLetterSpacing = `${t}px`),
            (n = !0))
          : ((r.letterSpacing = "0px"), (r.textLetterSpacing = "0px")));
      const i = r.measureText(e);
      let s = i.width;
      const o = -i.actualBoundingBoxLeft;
      let d = i.actualBoundingBoxRight - o;
      if (s > 0)
        if (n) (s -= t), (d -= t);
        else {
          const c = (g.graphemeSegmenter(e).length - 1) * t;
          (s += c), (d += c);
        }
      return Math.max(s, d);
    }
    static _wordWrap(e, t, r = g._canvas) {
      const n = r.getContext("2d", ne);
      let i = 0,
        s = "",
        o = "";
      const l = Object.create(null),
        { letterSpacing: d, whiteSpace: c } = t,
        u = g._collapseSpaces(c),
        f = g._collapseNewlines(c);
      let m = !u;
      const p = t.wordWrapWidth + d,
        h = g._tokenize(e);
      for (let _ = 0; _ < h.length; _++) {
        let x = h[_];
        if (g._isNewline(x)) {
          if (!f) {
            (o += g._addLine(s)), (m = !u), (s = ""), (i = 0);
            continue;
          }
          x = " ";
        }
        if (u) {
          const b = g.isBreakingSpace(x),
            T = g.isBreakingSpace(s[s.length - 1]);
          if (b && T) continue;
        }
        const S = g._getFromCache(x, d, l, n);
        if (S > p)
          if (
            (s !== "" && ((o += g._addLine(s)), (s = ""), (i = 0)),
            g.canBreakWords(x, t.breakWords))
          ) {
            const b = g.wordWrapSplit(x);
            for (let T = 0; T < b.length; T++) {
              ...
              for (; b[T + P]; ) {
                const W = b[T + P];
                if (!g.canBreakChars(B, W, x, T, t.breakWords)) C += W;
                else break;
                (B = W), P++;
              }
              T += P - 1;
              const M = g._getFromCache(C, d, l, n);
              M + i > p && ((o += g._addLine(s)), (m = !1), (s = ""), (i = 0)),
                (s += C),
                (i += M);
            }
          } else {
            s.length > 0 && ((o += g._addLine(s)), (s = ""), (i = 0));
            const b = _ === h.length - 1;
            (o += g._addLine(x, !b)), (m = !1), (s = ""), (i = 0);
          }
        else
          S + i > p && ((m = !1), (o += g._addLine(s)), (s = ""), (i = 0)),
            (s.length > 0 || !g.isBreakingSpace(x) || m) &&
              ((s += x), (i += S));
      }
      return (o += g._addLine(s, !1)), o;
    }
...
`
    ...
    static _getFromCache(e, t, r, n) {
      let i = r[e];
      return (
        typeof i != "number" && ((i = g._measureText(e, t, n) + t), (r[e] = i)),
        i
      );
    }
    ...
    static _tokenize(e) {
      ...
      for (let n = 0; n < e.length; n++) {
        const i = e[n],
          s = e[n + 1];
        if (g.isBreakingSpace(i, s) || g._isNewline(i)) {
    ...
    static measureFont(e) {
      ...
      const t = g._context;
      t.font = e;
      const r = t.measureText(g.METRICS_STRING + g.BASELINE_SYMBOL),
        n = {
      ...
      if (!g.__canvas) {
        ...
        try {
          const t = new OffscreenCanvas(0, 0),
            r = t.getContext("2d", ne);
          if (r != null && r.measureText) return (g.__canvas = t), t;
    ...
    static get _context() {
      return (
        g.__context || (g.__context = g._canvas.getContext("2d", ne)),
        g.__context
      );
    }
  };
...
let L = A;
const Te = 1e5;
function ee(a, e, t, r = 0) {
  if (a.texture === F.WHITE && !a.fill)
    return U.shared
      .setValue(a.color)
      .setAlpha(a.alpha ?? 1)
      .toHexa();
  if (a.fill) {
    if (a.fill instanceof xt) {
      const n = a.fill,
        i = e.createPattern(n.texture.source.resource, "repeat"),
        s = n.transform.copyTo(k.shared);
      return (
        s.scale(n.texture.frame.width, n.texture.frame.height),
        i.setTransform(s),
        i
      );
    } else if (a.fill instanceof _t) {
      const n = a.fill,
        i = n.type === "linear",
        s = n.textureSpace === "local";
      let o = 1,
        l = 1;
      s && t && ((o = t.width + r), (l = t.height + r));
      let d,
        c = !1;
      if (i) {
        const { start: u, end: f } = n;
        (d = e.createLinearGradient(u.x * o, u.y * l, f.x * o, f.y * l)),
          (c = Math.abs(f.x - u.x) < Math.abs((f.y - u.y) * 0.1));
      } else {
        const { center: u, innerRadius: f, outerCenter: m, outerRadius: p } = n;
      ...
      if (c && s && t) {
        ...
        for (let f = 0; f < t.lines.length; f++) {
          const m = (f * t.lineHeight + r / 2) / l;
          n.colorStops.forEach((p) => {
            const h = m + p.offset * u;
            d.addColorStop(
              Math.floor(h * Te) / Te,
              U.shared.setValue(p.color).toHex(),
            );
          });
        }
      } else
        n.colorStops.forEach((u) => {
          d.addColorStop(u.offset, U.shared.setValue(u.color).toHex());
        });
      return d;
    }
  } else {
    const n = e.createPattern(a.texture.source.resource, "repeat"),
      i = a.matrix.copyTo(k.shared);
    return (
      i.scale(a.texture.frame.width, a.texture.frame.height),
      n.setTransform(i),
      n
    );
  }
  return E("FillStyle not recognised", a), "red";
}
function Ke(a) {
  if (a === "") return [];
  typeof a == "string" && (a = [a]);
  ...
  for (let t = 0, r = a.length; t < r; t++) {
    ...
    if (Array.isArray(n)) {
      ...
      const i = n[0].charCodeAt(0),
        s = n[1].charCodeAt(0);
      if (s < i) throw new Error("[BitmapFont]: Invalid character range.");
      for (let o = i, l = s; o <= l; o++) e.push(String.fromCharCode(o));
...
const Ye = class Ne extends Lt {
  constructor(e) {
    ...
    const i = Z(r);
    t.overrideSize
      ? r._stroke && (r._stroke.width *= this.baseRenderedFontSize / n)
      : (r.fontSize = this.baseRenderedFontSize = n),
      (this._style = r),
      (this._skipKerning = t.skipKerning ?? !1),
      (this.resolution = t.resolution ?? 1),
      (this._padding = t.padding ?? 4),
      (this.fontMetrics = L.measureFont(i)),
      (this.lineHeight =
  ...
  ensureCharacters(e) {
    var _, x;
    const t = Ke(e)
      .filter((S) => !this._currentChars.includes(S))
      .filter((S, b, T) => T.indexOf(S) === b);
    if (!t.length) return;
    ...
    let { canvas: n, context: i } = r.canvasAndContext,
      s = r.texture.source;
    const o = this._style;
    ...
    let f = 0,
      m = !1;
    const p = n.width / this.resolution,
      h = n.height / this.resolution;
    for (let S = 0; S < t.length; S++) {
      const b = t[S],
        T = L.measureText(b, o, n, !1);
      T.lineHeight = T.height;
      const C = T.width * c,
        B = Math.ceil((o.fontStyle === "italic" ? 2 : 1) * C),
        P = T.height * c,
        M = B + u * 2,
        W = P + u * 2;
      if (
...
` &&
          ...
          b !== "	" &&
          b !== " " &&
          ((m = !0), (f = Math.ceil(Math.max(W, f)))),
        l + M > p && ((d += f), (f = W), (l = 0), d + f > h))
      ) {
        s.update();
        const H = this._nextPage();
        (n = H.canvasAndContext.canvas),
          (i = H.canvasAndContext.context),
          (s = H.texture.source),
          (d = 0);
      }
      const K =
        C / c -
        (((_ = o.dropShadow) == null ? void 0 : _.distance) ?? 0) -
      ...
      if (
        ...
        this._drawGlyph(i, T, l + u, d + u, c, o);
        const H = s.width * c,
          v = s.height * c,
          re = new le(
            (l / H) * s.width,
        ...
        (this.chars[b].texture = new F({ source: s, frame: re })),
          (l += Math.ceil(M));
      }
    }
    s.update(),
  ...
  _applyKerning(e, t) {
    ...
    for (let n = 0; n < e.length; n++) {
      ...
      for (let s = 0; s < this._currentChars.length; s++) {
        const o = this._currentChars[s];
        let l = r[i];
        l || (l = r[i] = t.measureText(i).width);
        let d = r[o];
        d || (d = r[o] = t.measureText(o).width);
        let c = t.measureText(i + o).width,
          u = c - (l + d);
        u && (this.chars[i].kerning[o] = u),
          (c = t.measureText(i + o).width),
          (u = c - (l + d)),
          u && (this.chars[o].kerning[i] = u);
      }
    }
  }
  _nextPage() {
    ...
    const e = this.resolution,
      t = O.getOptimalCanvasAndContext(this._textureSize, this._textureSize, e);
    ...
    const r = e * (this.baseRenderedFontSize / this.baseMeasurementFontSize),
      ...
      i = { canvasAndContext: t, texture: n };
  ...
  _setupContext(e, t, r) {
    ...
    const n = t._stroke,
      i = (n == null ? void 0 : n.width) ?? 0;
    if (
      (n &&
        ((e.lineWidth = i),
        (e.lineJoin = n.join),
        (e.miterLimit = n.miterLimit),
        (e.strokeStyle = ee(n, e))),
      t._fill && (e.fillStyle = ee(t._fill, e)),
      t.dropShadow)
    ) {
      const s = t.dropShadow,
        o = U.shared.setValue(s.color).toArray(),
        l = s.blur * r,
        d = s.distance * r;
      (e.shadowColor = `rgba(${o[0] * 255},${o[1] * 255},${o[2] * 255},${s.alpha})`),
        (e.shadowBlur = l),
        (e.shadowOffsetX = Math.cos(s.angle) * d),
        (e.shadowOffsetY = Math.sin(s.angle) * d);
    } else
      (e.shadowColor = "black"),
        (e.shadowBlur = 0),
        (e.shadowOffsetX = 0),
  ...
  _drawGlyph(e, t, r, n, i, s) {
    const o = t.text,
      l = t.fontProperties,
      d = s._stroke,
      c = ((d == null ? void 0 : d.width) ?? 0) * i,
      u = r + c / 2,
      f = n - c / 2,
      m = l.descent * i,
      p = t.lineHeight * i;
    s.stroke && c && e.strokeText(o, u, f + p - m),
      s._fill && e.fillText(o, u, f + p - m);
  }
  destroy() {
    super.destroy();
...
Ye.defaultOptions = { textureSize: 512, style: new V(), mipmap: !0 };
let Se = Ye;
function Xe(a, e, t, r) {
  const n = {
    width: 0,
  ...
  const l = { width: 0, start: 0, index: 0, positions: [], chars: [] },
    d = (p) => {
      ...
      for (let _ = 0; _ < l.index; _++) {
        ...
        i.chars.push(p.chars[_]), i.charPositions.push(x + h);
      }
      (i.width += p.width),
        (o = !1),
        (l.width = 0),
    ...
    c = () => {
      ...
      if (r) {
        let h = i.chars[p];
        for (; h === " "; )
          (i.width -= t.chars[h].xAdvance), (h = i.chars[--p]);
      }
...
` ||
      ...
      if (
        (!o && e.wordWrap && i.width + l.width - f > m
          ? (c(), d(l), _ || i.charPositions.push(0))
          : ((l.start = i.width), d(l), _ || i.charPositions.push(0)),
        h === "\r" ||
          h ===
            `
`)
        ...
        const C = x.xAdvance + (x.kerning[s] || 0) + f;
        (i.width += C),
          (i.spaceWidth = C),
      ...
      const T = x.kerning[s] || 0,
        C = x.xAdvance + T + f;
      (l.positions[l.index++] = l.width + T), l.chars.push(h), (l.width += C);
    }
    s = h;
  }
  return (
...
function Dt(a) {
  for (let e = 0; e < a.lines.length; e++) {
    ...
    for (let n = 0; n < t.charPositions.length; n++) t.charPositions[n] += r;
  }
}
function Ot(a) {
  for (let e = 0; e < a.lines.length; e++) {
...
class Vt {
  ...
  getFont(e, t) {
    ...
    let r = `${t.fontFamily}-bitmap`,
      n = !0;
    if (t._fill.fill && !t._stroke) (r += t._fill.fill.styleKey), (n = !1);
    else if (t._stroke || t.dropShadow) {
      let o = t.styleKey;
      (o = o.substring(0, o.lastIndexOf("-"))), (r = `${o}-bitmap`), (n = !1);
    }
    if (!z.has(r)) {
      const o = new Se({
        style: t,
      ...
      X++,
        X > 50 &&
          E(
            "BitmapText",
            `You have dynamically created ${X} bitmap fonts, this can be inefficient. Try pre installing your font styles using \`BitmapFont.install({name:"style1", style})\``,
          ),
        o.once("destroy", () => {
          X--, z.remove(r);
        }),
    ...
    const i = z.get(r);
    return (s = i.ensureCharacters) == null || s.call(i, e), i;
  }
  getLayout(e, t, r = !0) {
  ...
  install(...e) {
    ...
    typeof t == "string" &&
      ((t = {
        name: t,
        style: e[1],
        chars: (d = e[2]) == null ? void 0 : d.chars,
    ...
    const n = t.style,
      i = n instanceof V ? n : new V(n),
      s = i._fill.fill !== null && i._fill.fill !== void 0,
      o = new Se({
        style: i,
        overrideFill: s,
    ...
    return (
      ...
      z.set(`${r}-bitmap`, o),
      o.once("destroy", () => z.remove(`${r}-bitmap`)),
      o
    );
  }
  uninstall(e) {
...
class Qe {
  constructor(e) {
    (this._filterStackIndex = 0),
      (this._filterStack = []),
      (this._filterGlobalUniforms = new $({
      ...
      (this._globalFilterBindGroup = new Ge({})),
      (this.renderer = e);
  }
  ...
  push(e) {
    ...
    for (let p = 0; p < r.length; p++) {
      ...
      if (
        ((o = Math.min(
          o,
          h.resolution === "inherit" ? s._resolution : h.resolution,
        )),
        (l += h.padding),
        h.antialias === "off"
          ? (d = !1)
          : h.antialias === "inherit" && d && (d = s.antialias),
    ...
    (n.skip = !1),
      ...
      (n.inputTexture = G.getOptimalTexture(i.width, i.height, o, d)),
  ...
  pop() {
    ...
    if (
      ...
      s[0].apply(this, r, t.previousRenderSurface, !1), G.returnTexture(r);
    else {
      let o = t.inputTexture,
        l = G.getOptimalTexture(n.width, n.height, o.source._resolution, !1),
        d = 0;
      for (d = 0; d < s.length - 1; ++d) {
        s[d].apply(this, o, l, !0);
        const u = o;
        (o = l), (l = u);
      }
      s[d].apply(this, o, t.previousRenderSurface, !1),
        G.returnTexture(o),
        G.returnTexture(l);
    }
    t.blendRequired && G.returnTexture(i);
  }
  getBackTexture(e, t, r) {
    const n = e.colorTexture.source._resolution,
      i = G.getOptimalTexture(t.width, t.height, n, !1);
    let s = t.minX,
      o = t.minY;
    r && ((s -= r.minX), (o -= r.minY)),
      (s = Math.floor(s * n)),
      (o = Math.floor(o * n));
    const l = Math.ceil(t.width * n),
      d = Math.ceil(t.height * n);
    return (
  ...
  applyFilter(e, t, r, n) {
    const i = this.renderer,
      s = this._filterStack[this._filterStackIndex],
      o = s.bounds,
      l = yt.shared,
      c = s.previousRenderSurface === r;
    let u =
    ...
    (h[2] = t.frame.width),
      ...
      (S[0] = 0.5 * x[2]),
      (S[1] = 0.5 * x[3]),
      (S[2] = t.frame.width * _[2] - 0.5 * x[2]),
      (S[3] = t.frame.height * _[3] - 0.5 * x[3]);
    const C = this.renderer.renderTarget.rootRenderTarget.colorTexture;
    (b[0] = l.x * u),
      (b[1] = l.y * u),
      (b[2] = C.source.width * u),
      (b[3] = C.source.height * u);
    const B = this.renderer.renderTarget.getRenderTarget(r);
    if (
      (i.renderTarget.bind(r, !!n),
      r instanceof F
        ? ((T[0] = r.frame.width), (T[1] = r.frame.height))
        : ((T[0] = B.width), (T[1] = B.height)),
      (T[2] = B.isRoot ? -1 : 1),
      m.update(),
      i.renderPipes.uniformBatch)
    ) {
      const P = i.renderPipes.uniformBatch.getUboResource(m);
    ...
    this._globalFilterBindGroup.setResource(t.source, 1),
      ...
      i.type === ue.WEBGL && i.renderTarget.finishRenderPass();
  }
  _getFilterData() {
    return {
      skip: !1,
  ...
  calculateSpriteMatrix(e, t) {
    const r = this._activeFilterData,
      ...
      i = t.worldTransform.copyTo(k.shared),
      s = t.renderGroup || t.parentRenderGroup;
    return (
      s && s.cacheToLocalTransform && i.prepend(s.cacheToLocalTransform),
      i.invert(),
      n.prepend(i),
...
function Nt(a, e) {
  for (const t in a) {
    ...
    for (const i in r)
      we[i]
        ? n.push(we[i](r[i]))
        : ve[i] && n.push(ve[i].replace("{{VALUE}}", r[i]));
    e.push(`${t} { ${n.join(";")} }`);
  }
}
class pe extends V {
  ...
  _generateKey() {
    return (
      (this._styleKey = Tt(this) + this._cssOverrides.join("-")), this._styleKey
    );
  }
  update() {
...
function Xt(a, e, t, r) {
  ...
  (n.innerHTML = `<style>${e.cssStyle};</style><div style='padding:0'>${a}</div>`),
    n.setAttribute(
      "style",
...
class tt {
  ...
  execute(e) {
    ...
    (s.uTransformMatrix = e.groupTransform),
      ...
      te(e.groupColorAlpha, s.uColor, 0),
  ...
  _initBatchesForRenderable(e) {
    const t = e.context,
      ...
      i = r.batches.map((s) => {
        const o = w.get(St);
        return s.copyTo(o), (o.renderable = e), (o.roundPixels = n), o;
      });
    return (
...
class rt {
  constructor(e, t) {
    (this.localUniforms = new $({
      ...
      (this.localUniformsBindGroup = new Ge({ 0: this.localUniforms })),
  ...
  execute(e) {
    if (!e.isRenderable) return;
    e.state.blendMode = he(e.groupBlendMode, e.texture._source);
    ...
    (t.uniforms.uTransformMatrix = e.groupTransform),
      ...
      t.update(),
      te(e.groupColorAlpha, t.uniforms.uColor, 0),
      this._adaptor.execute(this, e);
  }
  _getMeshData(e) {
...
class qt {
  execute(e, t) {
    ...
    const s = n.gl,
      o = e.getBuffers(t);
    n.shader.bind(i), n.state.set(r), n.geometry.bind(o.geometry, i.glProgram);
    const d =
...
function Jt(a) {
  return { dynamicUpdate: Me(a, !0), staticUpdate: Me(a, !1) };
}
function Me(a, e) {
  const t = [];
  t.push(`
...
class Zt {
  constructor(e) {
    ...
    for (const c in r) {
      const u = r[c],
        f = de(u.format);
      u.dynamic ? (i += f.stride) : (n += f.stride);
    }
    (this._dynamicStride = i / 4),
      (this._staticStride = n / 4),
      (this.staticAttributeBuffer = new Y(t * 4 * n)),
      (this.dynamicAttributeBuffer = new Y(t * 4 * i)),
      (this.indexBuffer = Pe(t));
    const s = new We();
    let o = 0,
      l = 0;
    ...
    for (const c in r) {
      const u = r[c],
        f = de(u.format);
      u.dynamic
        ? (s.addAttribute(u.attributeName, {
  ...
  update(e, t) {
    e.length > this._size &&
      ...
      (this.staticAttributeBuffer = new Y(
        this._size * this._staticStride * 4 * 4,
      )),
      (this.dynamicAttributeBuffer = new Y(
        this._size * this._dynamicStride * 4 * 4,
      )),
      (this.indexBuffer = Pe(this._size)),
...
class nr extends fe {
  constructor() {
    const e = vt.from({ vertex: rr, fragment: tr }),
      t = wt.from({
...
class nt {
  ...
  _initBuffer(e) {
    return (
      (this._gpuBufferHash[e.uid] = new Zt({
  ...
  execute(e) {
    ...
    n.update(t, e._childrenDirty),
      (e._childrenDirty = !1),
      (i.blendMode = he(e.blendMode, e.texture._source));
...
it.extension = { type: [y.WebGLPipes], name: "particle" };
class st extends nt {
  constructor(e) {
    super(e, new Qt());
  }
}
st.extension = { type: [y.WebGPUPipes], name: "particle" };
class at {
  constructor(e) {
...
class ar extends fe {
  constructor() {
    ie ?? (ie = Le({ name: "tiling-sprite-shader", bits: [Wt, ir, Ie] })),
      se ?? (se = De({ name: "tiling-sprite-shader", bits: [Ht, sr, Oe] }));
    const e = new $({
...
function dr(a, e, t, r) {
  ...
  for (t *= e; n < i; ) {
    const f = a[t],
      m = a[t + 1];
    (a[t] = s * f + l * m + c), (a[t + 1] = o * f + d * m + u), (t += e), n++;
  }
}
function cr(a, e) {
  const t = a.texture,
  ...
  let i = 0,
    s = 0;
  a.applyAnchorToTexture && ((i = a.anchor.x), (s = a.anchor.y)),
    (e[0] = e[6] = -i),
    (e[2] = e[4] = 1 - i),
    (e[1] = e[3] = -s),
    (e[5] = e[7] = 1 - s);
  ...
  o.copyFrom(a._tileTransform.matrix),
    ...
    (o.ty /= a.height),
    o.invert(),
    o.scale(a.width / r, a.height / n),
    dr(e, 2, 0, o);
}
const q = new or();
class ot {
  constructor(e) {
    (this._state = J.default2d),
  ...
  addRenderable(e, t) {
    ...
    const n = this._getTilingSpriteData(e),
      { geometry: i, canBatch: s } = n;
    if (s) {
      n.batchableMesh || (n.batchableMesh = new ge());
  ...
  execute(e) {
    ...
    (r.uTransformMatrix = e.groupTransform),
      ...
      te(e.groupColorAlpha, r.uColor, 0),
      (this._state.blendMode = he(e.groupBlendMode, e.texture._source)),
...
class gr extends fe {
  constructor() {
    const e = new $({
      ...
      t = Rt();
    ae ?? (ae = Le({ name: "sdf-shader", bits: [Pt, Mt(t), ur, fr, Ie] })),
      oe ?? (oe = De({ name: "sdf-shader", bits: [Ft, Ut(t), hr, pr, Oe] })),
      super({
        glProgram: oe,
        gpuProgram: ae,
        resources: { localUniforms: e, batchSamplers: kt(t) },
      });
  }
}
class lt {
  ...
  _destroyRenderableByUid(e) {
    ...
    t.customShader && (w.return(t.customShader), (t.customShader = null)),
      w.return(this._gpuBitmapText[e]),
  ...
  _updateContext(e, t) {
    const { context: r } = t,
      n = $t.getFont(e.text, e._style);
    r.clear(),
      n.distanceField.type !== "none" &&
        (r.customShader || (r.customShader = w.get(gr)));
  ...
  _updateDistanceField(e) {
    const t = this._getGpuBitmapText(e).context,
      ...
      n = z.get(`${r}-bitmap`),
      { a: i, b: s, c: o, d: l } = e.groupTransform,
      d = Math.sqrt(i * i + s * s),
      c = Math.sqrt(o * o + l * l),
      u = (Math.abs(d) + Math.abs(c)) / 2,
      f = n.baseRenderedFontSize / e._style.fontSize,
      m = u * n.distanceField.range * (1 / f);
...
function ce(a, e) {
  ...
  (r.minX -= n), (r.minY -= n), (r.maxX -= n), (r.maxY -= n);
}
class dt {
  constructor(e) {
...
function ct(a, e, t, r) {
  ...
  (n.minX = 0),
    ...
    (n.maxX = (a.width / r) | 0),
    (n.maxY = (a.height / r) | 0);
  const i = G.getOptimalTexture(n.width, n.height, r, !1);
  return (
...
function _r(a, e) {
  ...
  for (const l in e.tagStyles) {
    const d = e.tagStyles[l].fontFamily;
    o(d);
  }
  return r;
}
async function br(a) {
  const t = await (await j.get().fetch(a)).blob(),
    r = new FileReader();
...
async function yr(a, e, t) {
  const r = a
    .filter((n) => z.has(`${n}-and-url`))
    .map((n, i) => {
      if (!Q.has(n)) {
        const { url: s } = z.get(`${n}-and-url`);
        i === 0
          ? Q.set(
              n,
              ke(
...
function Tr(a, e, t, r, n) {
  ...
  (i.innerHTML = `<style>${e.cssStyle}</style><div style='padding:0;'>${a}</div>`),
    ...
    (s.textContent = r);
  const { width: l, height: d } = n.image;
  return (
    o.setAttribute("width", l.toString()),
    o.setAttribute("height", d.toString()),
    new XMLSerializer().serializeToString(o)
  );
}
function Sr(a, e) {
  const t = O.getOptimalCanvasAndContext(a.width, a.height, e),
    { context: r } = t;
...
class me {
  constructor(e) {
    (this._activeTextures = {}),
      (this._renderer = e),
      (this._createCanvas = e.type === ue.WEBGPU);
  }
  getTexture(e) {
    return this._buildTexturePromise(e.text, e.resolution, e.style);
  }
  getManagedTexture(e, t, r, n) {
    ...
    const i = this._buildTexturePromise(e, t, r).then(
      (s) => ((this._activeTextures[n].texture = s), s),
    );
    return (
      (this._activeTextures[n] = { texture: null, promise: i, usageCount: 1 }),
      i
    );
  }
  async _buildTexturePromise(e, t, r) {
    const n = w.get(et),
      i = _r(e, r),
      s = await yr(i, r, pe.defaultTextStyle),
      o = Xt(e, r, s, n),
      l = Math.ceil(Math.ceil(Math.max(1, o.width) + r.padding * 2) * t),
      d = Math.ceil(Math.ceil(Math.max(1, o.height) + r.padding * 2) * t),
      c = n.image,
      u = 2;
    (c.width = (l | 0) + u), (c.height = (d | 0) + u);
    const f = Tr(e, r, t, s, n);
    await vr(c, f, mr() && i.length > 0);
    const m = c;
    let p;
    this._createCanvas && (p = Sr(c, t));
    const h = ct(p ? p.canvas : m, c.width - u, c.height - u, t);
    return (
      this._createCanvas &&
        (this._renderer.texture.initSource(h.source),
        O.returnCanvasAndContext(p)),
      w.return(n),
      h
    );
  }
...
class ut {
  ...
  initGpuText(e) {
    const t = { texture: null, currentKey: "--", batchableSprite: w.get(Ve) };
    return (
...
function ze(a, e, t, r, n) {
  const i = 4 * e;
  for (let s = r, o = r * i + 4 * t; s <= n; ++s, o += i)
    if (a[o + 3] !== 0) return !1;
  return !0;
}
function wr(a, e = 1) {
  ...
  let o = 0,
    ...
    c = r - 1;
  for (; l < r && Ae(s, t, l); ) ++l;
  if (l === r) return le.EMPTY;
  for (; Ae(s, t, c); ) --c;
  for (; ze(s, t, o, l, c); ) ++o;
  for (; ze(s, t, d, l, c); ) --d;
  return ++d, ++c, new le(o / e, l / e, (d - o) / e, (c - l) / e);
}
class ht {
  constructor(e) {
  ...
  getTextureSize(e, t, r) {
    const n = L.measureText(e || " ", r);
    let i = Math.ceil(Math.ceil(Math.max(1, n.width) + r.padding * 2) * t),
      s = Math.ceil(Math.ceil(Math.max(1, n.height) + r.padding * 2) * t);
    return (
      (i = Math.ceil(i - 1e-6)),
      (s = Math.ceil(s - 1e-6)),
      (i = ye(i)),
  ...
  getTexture(e, t, r, n) {
    ...
    const { texture: i, canvasAndContext: s } = this.createTextureAndCanvas(e);
    return (
      this._renderer.texture.initSource(i._source),
      O.returnCanvasAndContext(s),
      i
    );
  }
  createTextureAndCanvas(e) {
    const { text: t, style: r } = e,
      ...
      i = L.measureText(t || " ", r),
      s = Math.ceil(Math.ceil(Math.max(1, i.width) + r.padding * 2) * n),
      o = Math.ceil(Math.ceil(Math.max(1, i.height) + r.padding * 2) * n),
      l = O.getOptimalCanvasAndContext(s, o),
      { canvas: d } = l;
    this.renderTextToCanvas(t, r, n, l);
    const c = ct(d, s, o, n);
    if (r.trim) {
      const u = wr(d, n);
  ...
  getManagedTexture(e) {
    ...
    const { texture: r, canvasAndContext: n } = this.createTextureAndCanvas(e);
    return (
  ...
  decreaseReferenceCount(e) {
    ...
    t.usageCount--,
      t.usageCount === 0 &&
        (O.returnCanvasAndContext(t.canvasAndContext),
  ...
  renderTextToCanvas(e, t, r, n) {
    var S, b, T, C;
    const { canvas: i, context: s } = n,
      o = Z(t),
      l = L.measureText(e || " ", t),
      d = l.lines,
      c = l.lineHeight,
    ...
    for (let B = 0; B < x; ++B) {
      const P = t.dropShadow && B === 0,
        M = P ? Math.ceil(Math.max(1, p) + t.padding * 2) : 0,
        W = M * r;
      if (P) {
        (s.fillStyle = "black"), (s.strokeStyle = "black");
        const v = t.dropShadow,
          re = v.color,
          ft = v.alpha;
        s.shadowColor = U.shared.setValue(re).setAlpha(ft).toRgbaString();
        const pt = v.blur * r,
          xe = v.distance * r;
        (s.shadowBlur = pt),
          (s.shadowOffsetX = Math.cos(v.angle) * xe),
          (s.shadowOffsetY = Math.sin(v.angle) * xe + W);
      } else {
        if (
          ((s.fillStyle = t._fill ? ee(t._fill, s, l) : null),
          (b = t._stroke) != null && b.width)
        ) {
          const v = t._stroke.width * t._stroke.alignment;
          s.strokeStyle = ee(t._stroke, s, l, v);
        }
        s.shadowColor = "black";
      }
      let K = (c - m.fontSize) / 2;
      c - m.fontSize < 0 && (K = 0);
      const H = ((T = t._stroke) == null ? void 0 : T.width) ?? 0;
      for (let v = 0; v < d.length; v++)
        (h = H / 2),
          (_ = H / 2 + v * c + m.ascent + K),
          t.align === "right"
            ? (h += f - u[v])
            : t.align === "center" && (h += (f - u[v]) / 2),
          (C = t._stroke) != null &&
            C.width &&
  ...
  _drawLetterSpacing(e, t, r, n, i, s = !1) {
    ...
    if (
      ...
      s ? o.strokeText(e, n, i) : o.fillText(e, n, i);
      return;
    }
    let c = n;
    const u = L.graphemeSegmenter(e);
    let f = o.measureText(e).width,
      m = 0;
    for (let p = 0; p < u.length; ++p) {
      const h = u[p];
      s ? o.strokeText(h, c, i) : o.fillText(h, c, i);
      let _ = "";
      for (let x = p + 1; x < u.length; ++x) _ += u[x];
      (m = o.measureText(_).width), (c += f - m + l), (f = m);
    }
  }
  destroy() {
    this._activeTextures = null;
