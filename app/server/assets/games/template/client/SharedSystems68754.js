...
import { B as de, c as Je } from "./colorToUniform68754.js";
...
class Ze extends Ge {
  constructor(e) {
    const { sprite: t, ...r } = e,
      ...
      o = Oe.from({ vertex: Qe, fragment: Xe, name: "mask-filter" });
    super({
      ...r,
      gpuProgram: i,
      glProgram: o,
...
F._availableBatchers = Object.create(null);
let he = F;
...
class fe {
  ...
  execute(e) {
    ...
    if (e.action === "pushMaskBegin") {
      ...
      r &&
        (t.type === O.WEBGL && t.renderTarget.finishRenderPass(),
        t.renderTarget.pop(),
...
function rt(a) {
  ...
  for (const n in t) {
    ...
    i.stride ?? (i.stride = r[i.buffer.uid]),
      ...
      (s[i.buffer.uid] += $(i.format).stride);
  }
}
const _ = [];
_[f.NONE] = void 0;
...
class It {
  constructor(e) {
    (this.rootViewPort = new w()),
      (this.viewport = new w()),
      (this.onRenderTargetChange = new We("onRenderTargetChange")),
  ...
  renderStart({ target: e, clear: t, clearColor: r, frame: s }) {
    ...
    (this._renderTargetStack.length = 0),
      ...
      (this.renderingToScreen = nt(this.rootRenderTarget)),
  ...
  _initRenderTarget(e) {
    let t = null;
    return (
      U.test(e) && (e = ve(e).source),
      e instanceof A
        ? (t = e)
        : e instanceof T &&
          ((t = new A({ colorTextures: [e] })),
...
class be {
  ...
  _addRenderableCacheAsTexture(e, t) {
    const r = e._batchableRenderGroup ?? (e._batchableRenderGroup = g.get(de));
    (r.renderable = e.root),
  ...
  _executeCacheAsTexture(e) {
    if (e.textureNeedsUpdate) {
      ...
      this._renderer.renderTarget.push(e.texture, !0, null, e.texture.frame),
        ...
        I(e, this._renderer.renderPipes),
...
function lt(a) {
  ...
  if (a.renderGroupParent) {
    ...
    a.worldTransform.appendFrom(e.relativeGroupTransform, r.worldTransform),
      (a.worldColor = ae(e.groupColor, r.worldColor)),
...
function Q(a, e, t) {
  if (t & ie) {
    a.groupColor = ae(a.localColor, e.groupColor);
    ...
    if ((e.invalidateMatrices(), e.isCachedAsTexture)) {
      if (e.textureNeedsUpdate) {
        ...
        (e.texture = y.getOptimalTexture(r.width, r.height, i, o)),
          e._textureBounds || (e._textureBounds = new D()),
  ...
  _updateRenderGroups(e) {
    ...
    if (
      ...
      e.structureDidChange
        ? G(e.childrenRenderablesToUpdate.list, 0)
        : ut(e, r),
      ye(e),
      e.structureDidChange
...
const H = class Se {
  constructor() {
    (this.clearBeforeRender = !0),
      (this._backgroundColor = new le(0)),
...
class Me {
  ...
  _beginAdvancedBlendMode(e) {
    ...
    r || ((r = this._filterHash[t] = new re()), (r.filters = [new k[t]()]));
    const s = {
      renderPipeId: "filter",
      action: "pushFilter",
      renderables: [],
...
L.extension = { type: [u.WebGLSystem, u.WebGPUSystem], name: "extract" };
L.defaultImageOptions = { format: "png", quality: 1 };
let ht = L;
class z extends m {
  static create(e) {
    return new z({ source: new T(e) });
  }
  resize(e, t, r) {
    ...
    n
      ? (n =
          Array.isArray(n) && n.length === 4
            ? n
            : le.shared.setValue(n).toArray())
      : (n = mt);
    const i =
      ((d = e.frame) == null ? void 0 : d.copyTo(ft)) || Ne(s, pt).rectangle;
...
function gt(a) {
  if (!Z) {
    if (
      ue.get().getNavigator().userAgent.toLowerCase().indexOf("chrome") > -1
    ) {
      const e = [
...
`,
      ...
      globalThis.console &&
        globalThis.console.log(`PixiJS ${Y} - ${a} - http://www.pixijs.com/`);
    Z = !0;
  }
}
class W {
      ...
      (e
        ? ((this._handler = this._renderer.scheduler.repeat(
          ...
          (this._arrayHandler = this._renderer.scheduler.repeat(() => {
            for (const t of this._managedArrays) _t(t.context[t.hash]);
          }, this._frequency)))
...
N.extension = { type: [u.WebGLSystem, u.WebGPUSystem], name: "textureGC" };
N.defaultOptions = {
  textureGCActive: !0,
...
const j = class Ie {
  ...
  init(e) {
    (e = { ...Ie.defaultOptions, ...e }),
      e.view &&
        (qe(Ke, "ViewSystem.view has been renamed to ViewSystem.canvas"),
        (e.canvas = e.view)),
      (this.screen = new w(0, 0, e.width, e.height)),
      (this.canvas = e.canvas || ue.get().createCanvas()),
      (this.antialias = !!e.antialias),
      (this.texture = ve(this.canvas, e)),
      (this.renderTarget = new A({
...
j.defaultOptions = { width: 800, height: 600, autoDensity: !1, antialias: !1 };
let kt = j;
const Et = [ct, Re, W, kt, ke, Tt, Pe, ht, Ye, yt, Be],
  Dt = [Me, he, Ce, be, fe, me, pe, _e];
export {
  Gt as B,
  _ as G,
  It as R,
