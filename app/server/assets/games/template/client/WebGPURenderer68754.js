...
import { l as ge, a as me } from "./colorToUniform68754.js";
import {
  c as _e,
  u as be,
  U as ye,
  ...
  S as Te,
  a as Ce,
} from "./SharedSystems68754.js";
import { C as w } from "./CanvasPool68754.js";
const x = R.for2d();
class O {
  start(e, t, r) {
    const s = e.renderer,
...
class te {
  init() {
    const e = new k({
      ...
      t = H({ name: "graphics", bits: [de, he(pe()), ge, z] });
    this.shader = new F({ gpuProgram: t, resources: { localUniforms: e } });
  }
  execute(e, t) {
    const r = t.context,
    ...
    for (let _ = 0; _ < u.instructionSize; _++) {
      ...
      if (
        ...
        const S = m.textures;
        (m.bindGroup = E(S.textures, S.count)),
